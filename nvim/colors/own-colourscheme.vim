...
let colors_name = "own-colourscheme"
...
let s:black       = { "gui": "#171812", "cterm": "234" }
...
let s:brightgrey  = { "gui": "#808080", "cterm": "244" }
...
let s:purered     = { "gui": "#ff0000", "cterm": "160" }
let s:darkred     = { "gui": "#5f0000", "cterm": "52" }

let s:addfg       = { "gui": "#5a8f2d", "cterm": "71" }
let s:addbg       = { "gui": "#2d4a1f", "cterm": "22" }
let s:delfg       = { "gui": "#a63838", "cterm": "131" }
let s:delbg       = { "gui": "#4a1f1f", "cterm": "52" }
...
call s:h("DiffDelete",    { "bg": s:delbg })
call s:h("DiffChange",    { "bg": s:changebg })
call s:h("DiffText",      { "bg": s:aqua })
...
call s:h("PmenuSel",      { "fg": s:aqua,       "bg": s:lightblack2,        "format": "reverse,bold" })
...
call s:h("CocErrorFloat",           { "fg": s:purered, "bg": s:lightblack2 })

call s:h("CocWarningSign",          { "fg": s:orange, "bg": s:lightblack })
call s:h("CocWarningHighlight",     { "format": "underline" })
call s:h("CocWarningFloat",         { "fg": s:orange, "bg": s:lightblack2 })

call s:h("CocInfoSign",             { "fg": s:yellow, "bg": s:lightblack2 })
call s:h("CocInfoHighlight",        { "format": "underline" })

call s:h("CocHintSign",             { "fg": s:grey })
...
call s:h("jsArrowFuncArg",      { "fg": s:orange, "format": "italic" })
